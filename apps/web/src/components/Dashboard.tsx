  ...
  return (
    <div className="page-wrapper" style={{ color: "#fff" }}>
      ...
      <div style={{ marginBottom: "3rem" }}>
        <h1 className="page-title" style={{ color: "#CCFF00", fontSize: "2.5rem" }}>SWARM_TELEMETRY</h1>
        <p className="page-subtitle">Real-time synchronization with 32 autonomous agents across Arbitrum.</p>
      </div>
  ...
  return (
    <div className="glass-card" style={{ padding: "1.5rem", border: "1px solid rgba(255,255,255,0.05)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem" }}>
        <span style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: "0.1em" }}>{title}</span>
        {icon}
      </div>
      <div style={{ fontSize: "1.75rem", fontWeight: "900", color: "#fff" }}>{value}</div>
      <div style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.4)", marginTop: "0.25rem" }}>{sub}</div>
    </div>
  );
}
